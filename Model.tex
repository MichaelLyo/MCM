...
% 4.1.2
\subsubsection {MSN classification analysis} % TODO: by unit?
\begin{figure}[!h]%[!hptb] 
    \centering 
...
\par Here, we take the data of California in 2009 as an example to show the process of modeling.
...
\par So the biggest proportion is $\phi_{CA}$, which means that California has the biggest energy usage amount 
...
\end{itemize}
\par However, the socres based on the per capita renewable energy usage do not have a huge change, they are still in the region.
