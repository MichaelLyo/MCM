...
\begin{figure}[!hptb] 
    ...
    \caption{Scores of the four states from 1960 to 2009}
    \label{fit:B-level}
\end{figure}
...
\par Based on the consequences of problem B, we build regression equations, which show the relationships between the scores of the four states and years, so that we can predict the socres of the four states in 2025 and 2050.
...
\begin{equation}
    \centering
CA=e^{-0.32186 \times year+648.59297}+50
\end{equation}
\begin{equation}
    \centering
TX=100-CA-NM-AZ
...
\begin{equation}
    \centering
NM=0.03880 \times year-76.97412
\end{equation}
\begin{equation}
    \centering
AZ=e^{-0.09645 \times year+195.78165}
\end{equation}
\par The $R^{2}$ of each regression are greater than 0.54, even over 0.8. Therefore, the results of the regressions are good.
...
\end{table}
\par Besides, we can calculate scores in every year from 2025 to 2050, so that we can draw a line chart.
666666666666
