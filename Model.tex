...
\par For Problem A that, we should determine targets of the renewable energy usage for the four states in 2025 and 2050, which is based on the problems of Part \uppercase\expandafter{\romannumeral1}. 
=======
\subsubsection{Part \uppercase\expandafter{\romannumeral2}}
...
>>>>>>> 077461227385e131c8e451707e6a4ee30d2fb3a4
...
<<<<<<< HEAD
\par In order to analyze the closeness between each of the sectors and Y, we analyze the given data to obtain and then use the total renewable energy usage of each sector. According to the calculation method of the pairwise comparison matrix, we can obtain C, which is the pairwise comparison matrix of the five sectors under Y. Simply, we can calculate $\lambda_m$(C), which is the maximum of the eigenvalues of C. Here, n is equal to 4 and RI is equal to 1.12.\cite{6} If C can not pass the check equation for consistency:
=======
