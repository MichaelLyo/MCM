...
\par In order to obtain the amount of the total renewable energy usage of each states, we need to predict the total renewable energy usage of the four states.
...
\begin{equation}
    \centering
Totalamount=14466 \times year-27896894
\end{equation}
...
\hline
\end{tabular}
\caption{Scores and amount of four states in 2025 and 2050}
\end{table}
...
\renewcommand{\labelenumi}{(\theenumi)}
    ...
    \item In Problem D, the effects of regressions are very good.
\end{enumerate}
